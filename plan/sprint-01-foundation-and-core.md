...
> 历史 Sprint 记录，不是当前执行清单。2026-09-05 适用范围：本文保留原阶段设计；Excel 真源、永久删除、邮件字段增量、简历定义、全面面试准备、建议输出、Harness 与评测冲突项已由[当前规则](CURRENT-POLICY.md)替代。首发限制仅适用于 Stage 0–4；长期愿景为候选，不自动进入近期范围。
